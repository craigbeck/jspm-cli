...
const cfgEmitter = new CfgEmitter();
...
Config.prototype.emitter = cfgEmitter;
...
Config.prototype.read = function(prompts, sync) {
  ...
  console.log(chalk.magenta("cfg"), JSON.stringify(cfg, null, 2));
...
Config.prototype.write = function() {
  ...
  // console.log(chalk.bold.yellow("config/loader.write cfg"), cfg);
  ...
  this.emitter.emit("config", outConfig);
